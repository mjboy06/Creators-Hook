...
const TrustedBy: React.FC = () => {
  ...
  // Row 2: Left Side (Removing 65.png which was broken)
  const row2 = [
  ...
  const row3 = [
    ...
    "https://www.dropbox.com/scl/fi/xrmeloyh996k2nekvt9s2/64.png?rlkey=7zxzgnkh7hfa9462060g716qm&st=n46t5acg&dl=0",
